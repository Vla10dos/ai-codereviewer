...
const fetch = __importDefault(__nccwpck_require__(467));
...
function getAIResponse(prompt) {
    return __awaiter(this, void 0, void 0, function* () {
        const endpoint = "https://1vts9b3q5f9dgg-8000.proxy.runpod.net/v1/chat/completions";
        const headers = {
        ...
        try {
            const response = yield fetch.default(endpoint, {
                method: "POST",
                headers,
...
class OpenAI extends Core.APIClient {
     ...
     * API Client for interfacing with the OpenAI API.
     *
     * @param {string} [opts.apiKey==process.env['CUSTOM_API_KEY'] ?? undefined]
     ...
     */
    constructor({ apiKey = Core.readEnv('CUSTOM_API_KEY'), organization = Core.readEnv('OPENAI_ORG_ID') ?? null, ...opts } = {}) {
        if (apiKey === undefined) {
            throw new Errors.OpenAIError("The CUSTOM_API_KEY environment variable is missing or empty; either provide it, or instantiate the OpenAI client with an apiKey option, like new OpenAI({ apiKey: 'My API Key' }).");
        }
        const options = {
            apiKey,
            organization,
